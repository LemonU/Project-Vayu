...
\subsection{Functional Requirements}
    ...
    time it takes to sort the data.
        \subsection{Functional Requirements Priorities}
            \subsubsection{Sort Locations Based On Damage} Essential
            \subsubsection{Output Affected Regions to File} Essential
            \subsubsection{Display Affected Regions on Map} Conditional
